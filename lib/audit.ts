...
export interface AuditLogParams {
  action: 'CREATE' | 'READ' | 'UPDATE' | 'DELETE' | 'LOGIN' | 'LOGOUT' | 'PAGE_ACCESS' | 'EXPORT' | 'PRINT' | 'AI_OPTIMIZATION' | 'AI_PREDICTION' | 'APPLY' | 'SYNC' | 'RATE_LIMIT_EXCEEDED' | 'SUSPICIOUS_REGISTRATION_ATTEMPT' | 'DUPLICATE_EMAIL_REGISTRATION_ATTEMPT' | 'REGISTRATION_SECURITY_CHECK_PASSED' | 'REGISTRATION_SECURITY_CHECK_ERROR' | 'ACCEPT' | 'REJECT' | 'RESCHEDULE' | 'MFA' | 'SECURITY_EVENT' | 'CSRF_TOKEN_MISMATCH' | 'CSRF_TOKEN_INVALID_SIGNATURE' | 'CSRF_PROTECTION_BLOCKED' | 'REGISTRATION_RATE_LIMIT_EXCEEDED' | 'EMAIL_VERIFICATION_RATE_LIMIT_EXCEEDED' | 'FORM_SUBMISSION_RATE_LIMIT_EXCEEDED' | 'SUSPICIOUS_ACTIVITY_RATE_LIMIT_EXCEEDED' | 'RATE_LIMIT_EXCEEDED_FALLBACK' | 'SUSPICIOUS_REGISTRATION_DETECTED' | 'ERROR';
  resourceType: 'PATIENT' | 'MEDICAL_RECORD' | 'APPOINTMENT' | 'PAYMENT' | 'PAGE' | 'SYSTEM' | 'AUTH' | 'DOCTOR' | 'STAFF' | 'DEPARTMENT' | 'WARD' | 'BED' | 'EQUIPMENT' | 'SERVICE' | 'ADMISSION' | 'SCHEDULE' | 'LEAVE_REQUEST' | 'EXPORT_JOB' | 'SCHEDULING' | 'SCHEDULE_TEMPLATE' | 'SCHEDULE_EXCEPTION' | 'CALENDAR_INTEGRATION' | 'REGISTRATION' | 'MFA' | 'SECURITY' | 'RATE_LIMIT' | 'SCHEDULE_SERVICE';
  resourceId: string;
  patientId?: string;
  phiAccessed?: string[];
  reason?: string;
